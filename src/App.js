...
function AppContent() {
  ...
  const [appData, setAppData] = React.useState({
    ...
    importantDates: [],  // Initialize as empty array
    settings: {
        sessionsPerDay: 5
    }
  });
  ...
  const updateImportantDates = (dates) => {
    setAppData(prev => ({ ...prev, importantDates: dates }));
  };
    ...
    <div>
      ...
      <List>
        {[
          ...
          { text: 'Important Dates', icon: <EventIcon />, path: '/important-dates' },
        ...
        <Routes key={location.pathname}>
           <Route 
             ...
             element={
               <DashboardPage 
                 data={{
                   ...appData,
                   importantDates: appData.importantDates // Explicitly pass importantDates
                 }} 
               />
             } 
           />
           ...
           <Route 
             ...
             element={
               <ImportantDatesPage 
                 students={appData.students}
                 dates={appData.importantDates}
                 onUpdateDates={updateImportantDates}
               />
             } 
           />
        </Routes>
